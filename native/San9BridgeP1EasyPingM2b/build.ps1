...
$pins = @(
    ...
    @((Join-Path $PSScriptRoot 'include\s5_current_context.h'),'76500EB7FC978DE584FB8822127BA2950102015A28DD4A6B40C29DF5E562A974'),
    ...
    @((Join-Path $PSScriptRoot 'src\s5_current_context.c'),'CA0CCEC54CE5283E3BA22245A659FCBA8ECEDD7D9388D6E78A7821741AE70EC7'),
    @((Join-Path $PSScriptRoot 'src\s5_evidence.c'),'20515D4715A23168A5BE163C46606821C643938D80C47C79C656132732DDF09B'),
    @((Join-Path $PSScriptRoot 'src\controller.c'),'EF86D6E64F6B77D33D29088E34834E02CDE60186D17C29A5D4F3D82911D5D29A'),
    @((Join-Path $PSScriptRoot 'src\discover.c'),'B7687C7823E86C689B5B94FE345149786683D881A06E400400089DE7FBA7D5B2'),
    @((Join-Path $PSScriptRoot 'src\bridge_dll.c'),'36BE949FA8E959CE058E25E0DC3D94B6F888C5FEF1B3C9868900C4ACDB620CF4'),
    ...
    @((Join-Path $PSScriptRoot 'src\offline_selftest.c'),'51766C81AFF3D4A84A7E7B7AA84F72895210B6F1D4C58F94A4870EE7E880B88A'),
